...
export default function HomeContent() {
  ...
  useEffect(() => {
    const fetchElderships = async () => {
      const eldershipData = await axios.get(
        "http://www.k179seniunijosAPI.somee.com/api/eldership/"
      );
  ...
  return (
    <div className="home__content">
      ...
      <div
        className={`cover-container cover-container--1 ${
          !isFirstVisible && "cover-container--hidden"
        }`}
        ref={firstSlideRef}
      >
        <div className="highlighted highlighted--left">
          <h1 className="highlighted__text">
            Susipažink su <br />
            Lietuvos seniūnijomis
          </h1>
        </div>
      ...
      <div
        className={`cover-container cover-container--2 ${
          !isSecondVisible && "cover-container--hidden"
        }`}
        ref={secondSlideRef}
      >
        <div className="highlighted highlighted--right">
          <h1 className="highlighted__text">
            Sužinok apie <br />
            renginius seniūnijose
          </h1>
        </div>
        <div className="cover-buttons cover-buttons--right">
          <a
            className="cover-buttons__link"
            href="/map?events=true&places=true&free=true"
          >
            Renginiai
            <FontAwesomeIcon icon={faChevronRight} />
          </a>
      ...
      <div
        className={`cover-container cover-container--3 ${
          !isThirdVisible && "cover-container--hidden"
        }`}
        ref={thirdSlideRef}
      >
        <div className="highlighted highlighted--left">
      ...
      <div className="elderships" id="elderships">
        <h1 className="header__secondary u-text-center">
